...
export default function CampaignIntelligenceLayout() {
  ...
  const base = `/campaigns/${campaignId}/intelligence`;

  const navItems = [
    { path: base, label: 'List', icon: List },
    { path: `${base}/new`, label: 'New Record', icon: PlusCircle },
    { path: `${base}/search`, label: 'Search', icon: Search },
    { path: `${base}/schedule`, label: 'Schedule', icon: Calendar },
    { path: `${base}/visited`, label: 'Visited', icon: CheckCircle },
    { path: `${base}/booked`, label: 'Booked', icon: Bookmark },
  ];
  ...
  return (
    <CampaignContext.Provider value={{ campaignId: campaignId! }}>
      <div className="min-h-screen flex flex-col">
        ...
        <header className="sticky top-0 z-20 bg-card/80 backdrop-blur-lg border-b border-border">
          <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold tracking-tight">Campaign Intelligence</h1>
          </div>
