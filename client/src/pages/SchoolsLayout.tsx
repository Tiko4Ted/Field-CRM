...
const navItems = [
  { path: '/schools', label: 'List', icon: List },
  { path: '/schools/new', label: 'New Record', icon: PlusCircle },
  { path: '/schools/search', label: 'Search', icon: Search },
];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-20 bg-card/80 backdrop-blur-lg border-b border-border">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold tracking-tight">Schools</h1>
        </div>
